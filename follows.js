(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'pAcGDW5saOwuieLO80RxX04JnE2ztg9oUFGufdd5R2Xgv67v', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1791918639], // Comma separated array of Xively Feed ID numbers
			...
			if(feedData.datastreams) {
				...
				feedData.datastreams.forEach(function(datastream) {
					...
					if(duration == '6hours') diff = 21600000;
					 ...
					 if(duration == 'year') diff = 31536000000;
