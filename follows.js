...
//					if(duration == '6hours') diff = 21600000;
					...
					if(updated.getTime() > then.getTime()) {         //last updated data less than 1 week ago
						if(datastreamIds && datastreamIds != '' && datastreamIds.indexOf(datastream.id) >= 0) {      //correct datastream identified
							xively.datastream.history(feedId, datastream.id, {start: '2010-06-09T11:01:46Z', end: '2016-06-05T11:01:46Z', interval: '900', limit: 1000}, function(datastreamData) {       //puts data in datastreamData duration: '2weeks', interval: '1800' works
